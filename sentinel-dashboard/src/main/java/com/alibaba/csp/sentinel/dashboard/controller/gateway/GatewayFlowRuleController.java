...
//            List<GatewayFlowRuleEntity> rules = sentinelApiClient.fetchGatewayFlowRules(app, ip, port).get();
    ...
    public Result<GatewayFlowRuleEntity> addFlowRule(@RequestBody AddFlowRuleReqVo reqVo) {
        ...
        try {
            ...
            logger.error("Error when add gateway flow rules, app={}, ip={}", entity.getApp(),
                    entity.getIp(), e);
...
//        }
    ...
    public Result<GatewayFlowRuleEntity> updateFlowRule(@RequestBody UpdateFlowRuleReqVo reqVo) {
        ...
        try {
            ...
            Throwable e = t instanceof ExecutionException ? t.getCause() : t;
            logger.error("Error when update gateway flow rules, app={}, ip={}", entity.getApp(),
                    entity.getIp(), e);
            return Result.ofFail(-1, e.getMessage());
        }
...
//        }
    ...
    public Result<Long> deleteFlowRule(Long id) {
        ...
        try {
            ...
            Throwable e = t instanceof ExecutionException ? t.getCause() : t;
            logger.error("Error when delete gateway flow rules, app={}, ip={}", oldEntity.getApp(),
                    oldEntity.getIp(), e);
            return Result.ofFail(-1, e.getMessage());
        }
