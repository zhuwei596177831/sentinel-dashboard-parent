...
public class DashboardConfig {
     ...
     * nacos地址
     */
    public static final String CONFIG_NACOS_SERVE_URL = "sentinel.dashboard.nacos.server";
    /**
     * nacos namespace
     */
    public static final String CONFIG_NACOS_SERVE_NAMESPACE = "sentinel.dashboard.nacos.namespace";
    /**
     * nacos username
     */
    public static final String CONFIG_NACOS_SERVE_USERNAME = "sentinel.dashboard.nacos.username";
    /**
     * nacos password
     */
    public static final String CONFIG_NACOS_SERVE_PASSWORD = "sentinel.dashboard.nacos.password";
    ...
    public static String getNacosServer() {
        return getConfigStr(CONFIG_NACOS_SERVE_URL);
    }
